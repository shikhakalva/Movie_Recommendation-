...
movie_data <- read.csv("C:\\Users\\SHIKHA\\OneDrive\\Desktop\\3rd Year\\even sem\\sem project\\movies.csv",stringsAsFactors=FALSE)
nrow(movie_data)
View(movie_data)
dim(movie_data)
names(movie_data)
...
rating_data <- read.csv("C:\\Users\\SHIKHA\\OneDrive\\Desktop\\3rd Year\\even sem\\sem project\\ratings.csv")
View(rating_data)
str(rating_data)
